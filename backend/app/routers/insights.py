...
def generate_insights(
    ...
    """
    Generates AI insights for this company's analytics data.

    We cache insights for 1 hour (3600 seconds) because:
    1. AI API calls cost money
    2. Analytics data doesn't change second-by-second
    3. No need to regenerate insights on every dashboard refresh
    """
    ...
    # Gather analytics data to send to AI
    analytics_data = {
...
def get_insight_history(
    ...
    """Returns all past AI insights for this company."""
